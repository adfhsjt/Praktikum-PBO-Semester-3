...
public class FrmAnggota extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        for(Anggota an : list){
            rowData[0] = an.getIdanggota();
            rowData[1] = an.getNama();
            rowData[2] = an.getAlamat();
            rowData[3] = an.getTelepon();
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(txtIdAnggota, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Anggota an = new Anggota().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        an.delete();
        kosongkanForm();
        tampilkanData();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        an.setIdanggota(Integer.parseInt(txtIdAnggota.getText()));
        an.setNama(txtNama.getText());
        an.setAlamat(txtAlamat.getText());
        an.setTelepon(txtNoTelp.getText());
        an.save();
